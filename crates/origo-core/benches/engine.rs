//! Micro-benchmarks for the origo hot paths: the content-defined-chunking write
...
//!
//! Everything runs over the in-memory store so the numbers reflect origo's own CPU
//! cost (chunking, hashing, encoding), not disk or network.
//!
//! Run with `cargo bench -p origo-core`.

use criterion::{BenchmarkId, Criterion, Throughput, criterion_group, criterion_main};
use origo_core::{ContentStore, EncryptedStore, Fs, MemStore, SqliteMetadataStore};
use std::cell::Cell;
