...
/// [`OrigoError::Corrupt`] instead of being served as authentic (audit M1).
///
...
impl ContentStore for VerifyingStore {
    ...
    async fn get_range(&self, hash: &Hash, off: u64, len: u64) -> Result<Bytes> {
        ...
        // fetch and verify the whole object (origo objects are chunk-sized), then
